...
function Header({ sortType, setSortType }) {
  return (
    <>
      <div className="fixed top-0 left-0 bg-dark-background w-full p-4 pt-6 flex flex-col items-start gap-2 z-10">
        <h3 className="text-2xl font-bold text-light-text">VibeSphere</h3>
